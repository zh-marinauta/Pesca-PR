...
valueBox(
  value = paste(format(ano_geral$Barcos_ativos[length(ano_geral$Barcos_ativos)], big.mark = ".", decimal.mark = ","), "Barcos"),
...
valueBox(
  value = paste(format(ano_geral$Desembarques[length(ano_geral$Desembarques)], big.mark = ".", decimal.mark = ","), "Registros"),
...
```{r}
valueBox(
  value = paste(format(ano_geral$Peso[length(ano_geral$Peso)], big.mark = ".", decimal.mark = ","), "Kg"),
...
```{r}
valueBox(
  value = paste(format(ano_geral$Duzia[length(ano_geral$Duzia)], big.mark = ".", decimal.mark = ","), "Dz"),
...
```{r}
valueBox(
  value = paste(format(ano_geral$Receita[length(ano_geral$Receita)], big.mark = ".", decimal.mark = ","), "R$"),
